  ...
  return (
    <div className="details">
      ...
      {event.imageData ? (
        ...
        <div style={{ height: 200, borderRadius: 8, marginBottom: 12, background: event.color ? `linear-gradient(120deg, ${event.color}, #ffffff)` : 'linear-gradient(120deg, #fef3c7, #ffffff)'}} />
      )}
